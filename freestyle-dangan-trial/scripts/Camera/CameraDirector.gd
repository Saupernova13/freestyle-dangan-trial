...
func _execute_pan(bench_index: int, duration: float, ease: Tween.EaseType, trans: Tween.TransitionType):
	if _bench_camera and bench_index >= 0:
		_bench_camera.jump_to_bench(bench_index, true)
	await get_tree().create_timer(duration).timeout
	_finish_motion()

func _execute_zoom(target_fov: float, duration: float, ease: Tween.EaseType, trans: Tween.TransitionType):
...
func _execute_spin(duration: float, ease: Tween.EaseType, trans: Tween.TransitionType):
...
func _execute_overhead(duration: float, ease: Tween.EaseType, trans: Tween.TransitionType):
...
func _execute_low_angle(duration: float, ease: Tween.EaseType, trans: Tween.TransitionType):
...
func _execute_dolly(bench_index: int, distance: float, duration: float, ease: Tween.EaseType, trans: Tween.TransitionType):
...
func _execute_tracking(bench_index: int, duration: float, ease: Tween.EaseType, trans: Tween.TransitionType):
	if _bench_camera and bench_index >= 0:
		_bench_camera.jump_to_bench(bench_index, true)
	await get_tree().create_timer(duration).timeout
	_finish_motion()

func _execute_dutch_tilt(duration: float, ease: Tween.EaseType, trans: Tween.TransitionType):
...
func _execute_reset(duration: float, ease: Tween.EaseType, trans: Tween.TransitionType):
	var tween = _camera.create_tween()
	tween.set_ease(ease)
	tween.set_trans(trans)
	tween.set_parallel(true)
