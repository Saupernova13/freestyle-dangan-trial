...
const PATHS = {
  ...
  script:
    '<path d="M5 3h10l4 4v14H5z"/><path d="M15 3v4h4"/><path d="M8 13h8M8 17h8M8 9h3"/>',
  target:
  ...
  volume:
    '<path d="M11 5 6 9H2v6h4l5 4z"/><path d="M19 5a9 9 0 0 1 0 14M16 8a5 5 0 0 1 0 8"/>',
  warning:
  ...
  highlight:
    '<path d="m9 11-6 6v3h3l6-6"/><path d="m12 8 4-4 4 4-4 4z"/><path d="M15 5l3 3"/>',
  camera:
  ...
  swirl:
    '<path d="M12 21a9 9 0 1 0-9-9 6 6 0 0 0 6 6 4 4 0 0 0 4-4 2 2 0 0 0-2-2"/>',
  ...
  vibrate:
    '<rect x="8" y="4" width="8" height="16" rx="1"/><path d="M3 9v6M21 9v6"/>',
...
export function icon(name, opts = {}) {
  ...
  const fill = opts.fill || FILLED.has(name) ? 'currentColor' : 'none';
